...
export const AppThemeProvider = React.memo<Props>((props) => {
    ...
    const colorScheme = props.colorScheme === AppColorScheme.SYSTEM ? systemColorScheme : props.colorScheme;

    const [isDark, setIsDark] = React.useState(colorScheme === AppColorScheme.DARK);
    ...
    const theme = {
        isDark,
        themedColors: isDark ? colorPaletteContainer.dark : colorPaletteContainer.light,
